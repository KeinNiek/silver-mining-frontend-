// Silver Mining V3 IDL - Generated from deployed program
export const IDL = {
  ...
  "instructions": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        { "name": "miner", "writable": true, "pda": { "seeds": [{ "kind": "const", "value": [109, 105, 110, 101, 114] }, { "kind": "account", "path": "member" }] } },
    ...
    },
    {
      ...
      "accounts": [
        ...
        { "name": "config", "pda": { "seeds": [{ "kind": "const", "value": [99, 111, 110, 102, 105, 103] }] } },
        { "name": "round", "writable": true, "pda": { "seeds": [{ "kind": "const", "value": [114, 111, 117, 110, 100] }, { "kind": "account", "path": "config.current_round", "account": "Config" }] } },
        { "name": "bet", "writable": true, "pda": { "seeds": [{ "kind": "const", "value": [98, 101, 116] }, { "kind": "account", "path": "bettor" }, { "kind": "account", "path": "config.current_round", "account": "Config" }] } },
        { "name": "system_program", "address": "11111111111111111111111111111111" }
      ],
      "args": [
        { "name": "mine_level", "type": "u8" },
    ...
    {
      "name": "refine",
      "docs": ["Refine UNREFINED to SILVER - 90% to refiner, 10% to redistribution pool"],
    ...
    },
    {
      ...
      "accounts": [
        ...
        { "name": "miner", "writable": true, "pda": { "seeds": [{ "kind": "const", "value": [109, 105, 110, 101, 114] }, { "kind": "account", "path": "winner" }] } },
        { "name": "config", "writable": true, "pda": { "seeds": [{ "kind": "const", "value": [99, 111, 110, 102, 105, 103] }] } }
      ],
      "args": []
    },
  ...
  "accounts": [
    { "name": "AutoMiner", "discriminator": [48, 148, 141, 250, 248, 159, 16, 132] },
    { "name": "Bet", "discriminator": [147, 23, 35, 59, 15, 75, 155, 32] },
    { "name": "Config", "discriminator": [155, 12, 170, 224, 30, 250, 204, 130] },
    { "name": "Miner", "discriminator": [223, 113, 15, 54, 123, 122, 140, 100] },
    { "name": "Pool", "discriminator": [241, 154, 109, 4, 17, 177, 109, 188] },
    { "name": "Round", "discriminator": [87, 127, 165, 51, 73, 78, 116, 174] }
  ],
  "events": [
    { "name": "AutoMinerDeposit", "discriminator": [212, 139, 223, 108, 101, 87, 88, 55] },
    { "name": "AutoMinerSetup", "discriminator": [92, 248, 38, 131, 169, 188, 246, 36] },
    { "name": "AutoMinerWithdraw", "discriminator": [212, 109, 6, 121, 212, 181, 83, 79] },
    { "name": "BetPlaced", "discriminator": [88, 88, 145, 226, 126, 206, 32, 0] },
    { "name": "FeesDistributed", "discriminator": [209, 24, 174, 200, 236, 90, 154, 55] },
    { "name": "MinerInitialized", "discriminator": [93, 124, 2, 254, 199, 202, 90, 88] },
    { "name": "MotherlodeTriggered", "discriminator": [50, 253, 50, 221, 28, 36, 74, 109] },
    { "name": "PoolCreated", "discriminator": [202, 44, 41, 88, 104, 220, 157, 82] },
    { "name": "PoolJoined", "discriminator": [79, 207, 125, 205, 4, 167, 178, 115] },
    { "name": "PoolLeft", "discriminator": [99, 100, 26, 233, 89, 230, 153, 253] },
    { "name": "ProtocolInitialized", "discriminator": [173, 122, 168, 254, 9, 118, 76, 132] },
    { "name": "RedistributionClaimed", "discriminator": [80, 175, 101, 241, 58, 133, 101, 42] },
    { "name": "Refined", "discriminator": [99, 137, 123, 244, 229, 213, 120, 241] },
    { "name": "RoundFinalized", "discriminator": [43, 187, 17, 193, 36, 241, 48, 82] },
    { "name": "SilverClaimed", "discriminator": [159, 145, 90, 132, 67, 158, 13, 246] },
    { "name": "SolClaimed", "discriminator": [112, 80, 238, 167, 120, 101, 47, 207] },
    { "name": "Staked", "discriminator": [11, 146, 45, 205, 230, 58, 213, 240] },
    { "name": "StakingRewardsClaimed", "discriminator": [251, 169, 50, 96, 7, 92, 141, 137] },
  ...
  "errors": [
    ...
    { "code": 6004, "name": "RoundNotFinalized", "msg": "Round not finalized" },
    { "code": 6005, "name": "RoundAlreadyFinalized", "msg": "Round already finalized" },
    { "code": 6006, "name": "BettingClosed", "msg": "Betting closed" },
    { "code": 6007, "name": "NoBlocksSelected", "msg": "No blocks selected" },
    { "code": 6008, "name": "AlreadyClaimed", "msg": "Already claimed" },
    { "code": 6009, "name": "NothingToClaim", "msg": "Nothing to claim" },
    { "code": 6010, "name": "PoolFull", "msg": "Pool full" },
    { "code": 6011, "name": "AlreadyInPool", "msg": "Already in pool" },
    { "code": 6012, "name": "NotInPool", "msg": "Not in pool" },
    { "code": 6013, "name": "PoolNotFound", "msg": "Pool not found" },
    { "code": 6014, "name": "InvalidFee", "msg": "Invalid fee" },
    { "code": 6015, "name": "InvalidMineLevel", "msg": "Invalid mine level" },
    { "code": 6016, "name": "MineNotUnlocked", "msg": "Mine not unlocked" },
    { "code": 6017, "name": "MotherlodeNotTriggered", "msg": "Motherlode not triggered" },
    { "code": 6018, "name": "NothingToRefine", "msg": "Nothing to refine" },
    { "code": 6019, "name": "Overflow", "msg": "Overflow" },
    { "code": 6020, "name": "InvalidParameter", "msg": "Invalid parameter" },
    { "code": 6021, "name": "AlreadyInitialized", "msg": "Already initialized" },
    { "code": 6022, "name": "DailyLimitExceeded", "msg": "Daily withdrawal limit exceeded" },
    { "code": 6023, "name": "AutoMinerNotEnabled", "msg": "AutoMiner not enabled" },
    { "code": 6024, "name": "AutoMinerAlreadyExists", "msg": "AutoMiner already exists" },
    { "code": 6025, "name": "PoolMustBetAllBlocks", "msg": "Pool must bet all 5 blocks" }
  ],
  "types": [
    {
      "name": "AutoMiner",
...
export const DISCRIMINATORS = {
  ...
  // NEW: crank_autominer from upgraded v3 contract
