...
export const PickaxeIcon = ({ className = "", size = 24 }: IconProps) => (
...
export const ShieldIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M20 13c0 5-3.5 7.5-8.41 8.87a.39.39 0 0 1-.18 0C6.5 20.5 3 18 3 13V5.5a.5.5 0 0 1 .41-.48C6.21 4.5 9 3 12 3s5.79 1.5 8.59 2.02a.5.5 0 0 1 .41.48Z"/>
  </svg>
);

export const BlockIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
